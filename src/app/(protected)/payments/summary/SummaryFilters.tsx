...
export default function SummaryFilters({ onChange, banks }: Props) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
      ...
      <FormSelect name="groupBy" label="Group By" control={control} options={[
        { value: "bank", label: "Bank" },
        { value: "day", label: "Day" },
      ]} />
      <FormSelect name="mode" label="Mode" control={control} options={[
      ...
      <FormSelect name="bankAccount" label="Bank Account" control={control} options={[
